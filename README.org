...
* Сообщество
** Почтовая рассылка
Мы отправляем задания преподователям с:
...
Также можно подписаться на почтовую расслыку,
отправив письмо с занием на любой из этих электронный ящиков.
...
ЧАТ комнаты *6005* и *6005-offtopic*.

** Встречи
*** 2016-09-14 | Первая заочная встреча | [[file:meeting/14.09.16/README.org][Link]]
...
Расписание занятий висит в ВУЗе на 2 этаже корпус 3.
...
- Допускается совпадение около половины на сайте [[https://www.antiplagiat.ru/][Антиплагиат.ру]]
- 10000-20000 знаков (10 листов) в общем на 3 вопроса.
- 14 размер TimesNewRoman

Подробнее можно посмотреть на [[https://yadi.sk/i/8FF1acSAvWKf7][Yandex.Disk]]
...
- Пройти тест
- На всякий случай (обрыв связи, потеря интернета) дается 2 попытки
...
тест)
*** TODO | [[https://yadi.sk/d/lEmOIxyhvStZ7][Иностранный язык]] | [[https://yadi.sk/i/ywPrDlwjxgdPR][Вопросы]]
